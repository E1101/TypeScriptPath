/**
 * Composite is a pattern that offers an alternative way to define hierarchies
 * of objects without using inheritance. Again, you want a pattern that avoids
 * inheritance as much as possible because inheritance has many drawbacks in practice.
 */

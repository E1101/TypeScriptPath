/**
 * Observer is a behavioral design pattern that establishes a subscription model
 * of communication. In simple words, you use a publisher object that posts messages
 * to a list of active subscribers either in regard to some events that occur
 * or when a specific rule is activated.
 */

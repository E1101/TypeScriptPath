// Using Lens, you can provide an easier API for getting and setting those properties.
// For convenience and type safety, we'll show an example of how we can use monocle-ts,
// which is a Lens library for TypeScript, to perform the same update operations that
// we performed previously:
